                    ...
                    <div class="box-body">
                        <div class="col-md-5">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                ...
                                <div class="fileupload-preview fileupload-exists thumbnail" style="width: 400px; height: 235px; margin-top: 18px; line-height: 0px"></div>
                                <div>
                        ...
                        <div class="col-md-7">
                            ...
                            <div class="form-group {{ $errors->first('teaser') ? 'has-error' : '' }}">
                                <label for="">Mô tả <b style="color: red">*</b></label>
                                <textarea class="form-control" name="teaser" rows="4" placeholder="Mô tả">{{ old('teaser') }}</textarea>
                        ...
                        <div class="col-md-12 {{ $errors->first('content') ? 'has-error' : '' }}">
                            ...
                            <div class="form-group">
                                ...
                                <select multiple="true" name="tags[]" id="tags_blog" class="form-control select2" value="">
                                    @if (Request::old('tags'))
                                       @foreach (Request::old('tags') as $tag)
                            ...
                            <div class="form-group">
                                <input type="checkbox" id="hot" class="flat-red" name="hot" value="1" {{ Request::old('hot') ? 'checked' : '' }}>
