            ...
            <div class="box box-success">
            	<div class="box-header with-border">
            	    ...
            	    <span class="pull-right">
            	    	<a href="{{ route('accounts.index') }}" class="btn btn-sm btn-default"><i class="fa fa-long-arrow-left"></i> Trở lại</a>
            	    </span>
            	</div>
                	...
                	<div class="box-body">
						...
						<div class="col-md-8">
							<div class="form-group {{ $errors->first('username') ? 'has-error' : '' }}">
								...
								<input type="text" class="form-control" name="username" placeholder="Tên nhân viên" value="{{ old('username') }}">
								<span class="help-block">{{ $errors->first('username') }}</span>
							</div>
							<div class="form-group {{ $errors->first('name') ? 'has-error' : '' }}">
								<label for="">Tên nhân viên <b style="color: red">*</b></label>
								<input type="text" class="form-control" name="name" placeholder="Tên nhân viên" value="{{ old('name') }}">
							...
							<div class="form-group {{ $errors->first('address') ? 'has-error' : '' }}">
								...
								<input type="text" class="form-control" name="address" placeholder="Số điện thoại" value="{{ old('address') }}">
								<span class="help-block">{{ $errors->first('address') }}</span>
							</div>
							<div class="form-group {{ $errors->first('basic_salary') ? 'has-error' : '' }}">
								<label for="">Lương cơ bản <b style="color: red">*</b></label>
								<input type="text" class="form-control" name="basic_salary" placeholder="Tiền lương cơ bản hàng tháng" value="{{ old('basic_salary') }}">
							...
							<div class="form-group {{ $errors->first('start_date') ? 'has-error' : '' }}">
								...
								<input type="text" id="start_date" class="form-control" name="start_date" placeholder="Ngày bắt đầu làm việc" value="{{ old('start_date') }}">
